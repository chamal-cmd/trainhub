          ...
          <div className="flex-1 overflow-y-auto py-2">
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    active ? 'bg-indigo-50 border-indigo-500' : 'border-transparent hover:bg-white hover:border-slate-200'
                  )}
                >
                  {done ? (
            ...
            {allDone && (
              <button
                ...
                className="flex items-center gap-3 w-full px-4 py-3 text-left transition-all group border-r-2 border-transparent hover:bg-white hover:border-indigo-200 mt-1 border-t border-slate-100"
              >
                <Sparkles className="w-4 h-4 text-indigo-400 shrink-0" />
                <p className="text-xs font-medium text-indigo-600">Knowledge check quiz</p>
              </button>
            )}
          </div>
        </div>
