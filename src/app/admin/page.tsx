    ...
    <div className="p-6 md:p-8 max-w-6xl">
      ...
      <div className="flex items-start justify-between mb-8 gap-4">
        ...
        <Link href="/admin/subjects/new">
          <button className="flex items-center gap-2 bg-violet-700 hover:bg-violet-800 text-white text-sm font-semibold px-4 py-2.5 rounded-xl transition-colors shadow-sm shadow-violet-300 shrink-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
        ...
        <div className="lg:col-span-3 bg-white rounded-2xl border border-slate-100 overflow-hidden">
          <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100">
            ...
            <Link
              href="/admin/subjects"
              className="flex items-center gap-1 text-xs text-violet-700 hover:text-violet-800 font-semibold"
            >
          ...
          {recentSubjects && recentSubjects.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-14 text-center px-6">
              ...
              <Link href="/admin/subjects/new" className="text-xs text-violet-700 hover:underline">
                Create your first →
              </Link>
            </div>
          )}
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mt-4">
        {[
          ...
          <Link key={q.href} href={q.href}>
            <div className="bg-white border border-slate-100 hover:border-violet-300 rounded-xl p-4 hover:shadow-sm transition-all group cursor-pointer">
              <span className="text-xl">{q.emoji}</span>
              <p className="text-sm font-semibold text-slate-800 group-hover:text-violet-700 transition-colors mt-2">{q.label}</p>
