    ...
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="flex gap-3 mb-4">
        ...
        <button
          ...
          disabled={uploading}
          className="flex items-center gap-2 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-xl transition-colors disabled:opacity-60"
        >
      ...
      <div
        ...
        className={`mb-5 rounded-2xl border-2 border-dashed transition-all ${
          dragging ? 'border-indigo-400 bg-indigo-50' : 'border-slate-100 bg-slate-50/50'
      ...
      {showPaste && (
        <div className="mb-5 bg-white rounded-2xl border border-slate-200 p-5 shadow-sm">
          ...
          <input
            ...
            className="w-full text-sm border border-slate-200 rounded-xl px-3 py-2 mb-3 outline-none focus:ring-2 focus:ring-indigo-400"
          />
          <textarea
            ...
            rows={8}
            className="w-full text-sm border border-slate-200 rounded-xl px-3 py-2 mb-3 outline-none focus:ring-2 focus:ring-indigo-400 resize-y"
          />
